  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.body}>
        MakeOpenSource built the MOS Authenticator app as an Open Source app. This SERVICE is provided by
        MakeOpenSource at no cost and is intended for use as is.
        ...
        accessible at MOS Authenticator unless otherwise defined in this Privacy Policy.
      </Text>
      <Text style={styles.header}>Information Collection and Use</Text>
      <Text style={styles.body}>
        For a better experience, while using our Service, we may require you to provide us with certain
        personally identifiable information, including but not limited to none. The information that we request
      ...
      <Text style={styles.header}>Children's Policy</Text>
      <Text style={styles.body}>
